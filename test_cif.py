...
def subprocess_fn(args):
    ...
    for cif_file in glob.glob('./data/train4w2023/test_cif/*.cif'):
        ...
        positions = [
            1 / structure.lattice.a,
            1 / structure.lattice.b,
            1 / structure.lattice.c,
            structure.lattice.angles[0] / 180,
            structure.lattice.angles[1] / 180,
            structure.lattice.angles[2] / 180,
